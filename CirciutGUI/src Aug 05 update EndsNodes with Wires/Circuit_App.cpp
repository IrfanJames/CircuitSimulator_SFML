...
void App::EndFrame()
{
	...
	CircuitGUI::app.setTitle("CircuitSim   " + std::to_string((double)(((double)clock() - (double)FrameTime_for_FPS) / (double)CLOCKS_PER_SEC) * 1000.0F) + " | " + std::to_string((double)((double)CLOCKS_PER_SEC / ((double)clock() - (double)FrameTime_for_FPS))));
